...
<div>
	<p>카테고리 삭제 화면입니다.</p>
	<form action="deleteCategory.do" name="fmC" onSubmit="return check()">
...
function check(){
	alert("check()호출됨");
	let s_inex = ""; switch(document.fmC.S_INEX.value){
	...
	if(! confirm("삭제될 cate_code : "+document.fmC.CCODE.value) ) return false;
}
